    ...
    const passwordFieldHTML = html`
      <div class="form-group" style="margin-bottom: 16px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 6px;">
          <label class="form-label" for="auth-pwd-input" style="font-size: 12px; font-weight: 700; color: var(--text-secondary); margin: 0; display: block;">Password ${isHrOrManager ? '*' : '(Optional)'}</label>
        ...
        <div style="position:relative">
          <input type="password" id="auth-pwd-input" class="form-input" placeholder="${isHrOrManager ? 'Enter account password' : 'Enter password (or leave blank)'}" style="background: rgba(255,255,255,0.02); font-size: 13px; padding-right: 40px;">
